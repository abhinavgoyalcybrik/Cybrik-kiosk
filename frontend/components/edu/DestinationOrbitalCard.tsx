...
const destinations = [
  { country: "Australia", universities: 6, programs: 24, cities: ["Melbourne", "Sydney", "Brisbane"], scholarship: "Up to ₹8L", opportunities: 3, intake: "February 2027", status: "Applications open", fit: 96 },
  { country: "Canada", universities: 11, programs: 42, cities: ["Toronto", "Vancouver", "Ottawa"], scholarship: "Up to ₹12L", opportunities: 5, intake: "July 2027", status: "Early applications", fit: 93 },
  { country: "United Kingdom", universities: 14, programs: 51, cities: ["London", "Manchester", "Edinburgh"], scholarship: "Up to ₹15L", opportunities: 8, intake: "September 2027", status: "Applications open", fit: 91 },
  { country: "Germany", universities: 9, programs: 31, cities: ["Berlin", "Munich", "Hamburg"], scholarship: "Up to ₹6L", opportunities: 4, intake: "January 2028", status: "Limited seats", fit: 88 },
  { country: "Ireland", universities: 7, programs: 28, cities: ["Dublin", "Cork", "Galway"], scholarship: "Up to ₹10L", opportunities: 5, intake: "September 2027", status: "Closing soon", fit: 85 },
] as const;
...
export function DestinationOrbitalCard() {
  ...
  return <div className="feature-visual destination-stage" data-craft-reactive>
