          ...
          <section className="hero section-pad">
            ...
            <div className="hero-intelligence" data-hero-sequence data-visible="true" data-craft-reactive aria-label="Personalized study planning preview">
              <div className="hero-photo-row">
                <div className="college-image-card" data-hero-item style={{ "--hero-delay": "0ms" } as React.CSSProperties}><Image src="/student-campus-1.webp" alt="Students discussing university plans on campus" fill priority loading="eager" sizes="(max-width: 560px) 50vw, 300px" /><span>Campus life</span></div>
                <div className="college-image-card secondary" data-hero-item style={{ "--hero-delay": "80ms" } as React.CSSProperties}><Image src="/student-campus-2.webp" alt="International students connecting on campus" fill sizes="(max-width: 560px) 50vw, 300px" /><span>Global community</span></div>
              </div>
              <div className="hero-widget-grid">
                ...
                <article className="hero-widget journey-widget" data-hero-item style={{ "--hero-delay": "660ms" } as React.CSSProperties}><span>Your journey</span><ol>{["Register","Preference","Shortlist","Course Details","Counselling"].map((milestone,index)=><li key={milestone} className={index<3?"done":""} style={{ "--milestone-delay": `${760+index*110}ms` } as React.CSSProperties}><i>{index<3&&<Check size={9}/>}</i><b>{milestone}</b></li>)}</ol></article>
              </div>
            </div>
          </section>
        </SmoothScrollHero>
