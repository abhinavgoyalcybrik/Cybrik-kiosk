  ...
  return (
    <main className="site-shell">
      ...
      <div id="main-content">
          ...
          <section className="hero section-pad">
            ...
            <div className="hero-intelligence" data-hero-sequence data-visible="true" data-craft-reactive aria-label="Personalized study planning preview">
              <div className="hero-photo-row" data-hero-item style={{ "--hero-delay": "0ms" } as React.CSSProperties}>
                <div className="college-image-card"><Image src="/student-campus-1.webp" alt="Students discussing university plans on campus" fill sizes="(max-width: 820px) 42vw, 210px" /><span>Campus life</span></div>
        ...
        <section className="feature-section section-pad" id="features" data-reveal data-cursor-intent><div className="feature-visual" data-craft-reactive><div className="country-card country-main"><Globe size={28} /><span>Explore destinations</span><strong>Australia</strong><small>6 universities · 24 programs</small><div className="city-pills"><b>Melbourne</b><b>Sydney</b><b>Brisbane</b></div></div><div className="floating-card scholarship"><span>Scholarship match</span><strong>Up to ₹8L</strong><small>3 opportunities found</small></div><div className="floating-card deadline"><span>Next intake</span><strong>February 2027</strong><small>Applications open</small></div></div><div className="feature-copy"><span className="kicker">Built around your reality</span><h2>Recommendations that make sense—not just more options.</h2><p>Every result explains why it fits. Adjust your budget, city, or course and watch your shortlist respond instantly.</p><ul className="feature-list"><li><span><Graduation /></span><div><strong>Eligibility comes first</strong><p>Programs you don’t qualify for stay out of the way.</p></div></li><li><span><Spark /></span><div><strong>A match score you can understand</strong><p>See how academics, language, budget, and preferences contribute.</p></div></li><li><span><FileText /></span><div><strong>One organized document plan</strong><p>Know what’s ready, what needs action, and what comes next.</p></div></li></ul><Link href="/portal" className="inline-link">Build my student profile <ArrowRight /></Link></div></section>
        <section className="story-section section-pad" id="stories" data-reveal data-cursor-intent><div className="quote-mark">“</div><blockquote>Cybrik didn’t just give me a list. It helped me understand why RMIT fit my goals and what I needed to do next.</blockquote><div className="student"><div className="student-avatar">NK</div><div><strong>Naina Kapoor</strong><span>Master of Analytics · Melbourne</span></div></div></section>
