    ...
    <main className="site-shell">
      ...
      <div id="main-content">
        <section className="hero section-pad">
          ...
          <div className="hero-product reveal delay-one" data-craft-reactive aria-label="University match preview">
        ...
        <section className="proof-strip" data-reveal aria-label="Platform highlights">
        ...
        <section className="journey section-pad" id="how" data-reveal data-cursor-intent>
        ...
        <section className="feature-section section-pad" id="features" data-reveal data-cursor-intent>
          <div className="feature-visual" data-craft-reactive>
        ...
        <section className="story-section section-pad" id="stories" data-reveal data-cursor-intent>
